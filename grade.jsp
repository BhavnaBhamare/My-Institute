		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 col-md-pull-2 slider-text">
			   				<div class="slider-text-inner">
			   					<h1>Result<strong>Form</strong></h1>
						...
						<div class="col-md-6">
							...
							<form action="SaveGrade"   method="post">									
								<div class="row form-group">
									<div class="col-md-6">
										<label id="lablecolor" for="fname">Student Name</label>
										<input type="text" name="name" class="form-control mb" placeholder="Your firstname"    id="fname"   
										required>
									</div>								
									<div class="col-md-6">
										<label id="lablecolor" for="lname">Course</label>
								...
								<div class="row form-group">
									<div class="col-md-6">
										<label for="username"   id= "lablecolor" >Total Marks</label>		
										<input type="number"  name="tm"	class="form-control"	    
										 required>																	
																</div>
								</div>
								<div class="row form-group">
									<div class="col-md-6">
											<label for="password"    id="lablecolor" >Obtained Marks</label>																					
													<input type="number"	 name="om"
class="form-control"	     required>												
										</div>	
									</div>
									<div class="col-md-6">
									<label for="username"   id= "lablecolor" >Status</label>
