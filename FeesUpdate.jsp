								...
								<div class="row form-group">
									<div class="col-md-6">
										<div class="col-md-6">
											...
											<input type="text" id="fname" class="form-control" placeholder="Your firstname"    value="${list.fname}"   
											name="fname"    required>
										</div>
										<div class="col-md-6">
												<label id="lablecolor" for="lname">Last Name</label>
												<input type="text" id="lname" class="form-control" placeholder="Your lastname "    value="${list.lname}"   
												name="lname"    required>
										</div>
									</div>		
									<div class="col-md-6">
										<div class="col-md-6">
											...
											<input type="text" id="tfees" class="form-control mb" placeholder="Total Fees"    value="${list.totalfees}"   
											name="tfees"    required>
										</div>
								...
								<div class="row form-group">
										<div class="col-md-6">
												<div class="col-md-6">
														...
														<input type="text" id="finst" class="form-control mb" placeholder="1st Instalment"    value="${list.finst}"   
														name="finst"    onkeyup="sum();"   required>
													</div>																				
												<div class="col-md-6">
													<label for="finstdate" id="lablecolor" >Date</label>
													<input type="date" id="finst" class="form-control" placeholder="Instalment Date"    value="${list.fdate}"   
													name="fdate"    required>
												</div>
										</div>		
										<div class="col-md-6">
												<div class="col-md-6">
														...
														<input type="text" id="sinst" class="form-control mb" placeholder="2nd Instalment "
value="${list.sinst}"    name="sinst"    onkeyup="sum();"  required>													</div>																				
												<div class="col-md-6">
													<label for="sinstdate" id="lablecolor" >Date</label>
													<input type="date" id="sinstdate" class="form-control" placeholder="Instalment Date"    value="${list.sdate}"  
													name="sdate"   required>
												</div>
										</div>										
									</div>	
									<div class="row form-group">
											<div class="col-md-6">
													<div class="col-md-6">
															...
															<input type="text" id="tinst" class="form-control mb" placeholder="3rd Instalment"   value="${list.tinst}"   
															name="tinst"    onkeyup="sum();"  required>
														</div>																				
													<div class="col-md-6">
														<label for="tinstdate" id="lablecolor" >Date</label>
														<input type="date" id="tinstdate" class="form-control" placeholder="Instalment Date"   value="${list.tdate}"   
														name="tdate"    required>
													</div>
											</div>		
											...
											function sum() {
											      var txtFirstNumberValue = document.getElementById('finst').value;
											      var txtSecondNumberValue = document.getElementById('sinst').value;
											      var txtthirdNumberValue = document.getElementById('tinst').value;
											...
											<div class="col-md-6">
													<div class="col-md-6">
															...
															<input type="text" id="balance" class="form-control mb" placeholder="Balance"    value="${list.rbalance}"   
