							...
							<form action="RegisterServlet"   method="post">									
								<div class="row form-group">
									<div class="col-md-6">
										...
										<input type="text" name="fname" class="form-control mb" placeholder="Your firstname"    id="fname"   
										required>
									</div>								
									<div class="col-md-6">
										<label id="lablecolor" for="lname">Last Name</label>
										<input type="text" name="lname" class="form-control" placeholder="Your lastname"    id="lname"   
										required>
									</div>
								</div>
								...
								<div class="row form-group">
									<div class="col-md-6">
										<label for="username"   id= "lablecolor" >UserName</label>		
										<input type="text"  name="user"	class="form-control"	 placeholder="Your UserName"    id="user"  
										 required>																	
																</div>
								</div>
								<div class="row form-group">
									<div class="col-md-6">
											<label for="password"    id="lablecolor" >Password</label>																					
													<input type="password"	 name="pass"
class="form-control"	 placeholder="Your Password"    id="pass"    required>												
										</div>	
									
									<div class="col-md-12">
										<label id="lablecolor" for="email">Email</label>
										<input type="email" name="email" class="form-control" placeholder="Your email address"    id="email"   
										required>
									</div>
								
														
									<div class="col-md-6">
										<label for="contact"   id="lablecolor" >Contact</label>
										<input type="number"  name="contact" class="form-control" placeholder="Your  Contact"   id="contact"   
										required>
									</div>
								</div>
								...
								function sucessfull()
								{
									 ...
									 var pass = document.getElementById("pass").value;
											 ...
											 else  if (pass == null || pass == ""||pass.length<5)
											  {
												    alert(  "Password required with length >5");
